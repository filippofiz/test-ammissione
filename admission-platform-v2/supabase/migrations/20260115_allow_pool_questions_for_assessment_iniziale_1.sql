-- Migration: Allow questions from pool for GMAT Assessment Iniziale test 1
-- Date: 2026-01-15
-- Purpose: Modify validation trigger to allow any GMAT question for Assessment Iniziale test 1
...
BEGIN
  ...
  -- SPECIAL CASE: GMAT Assessment Iniziale test 1 can use any GMAT question
  IF v_test_type = 'GMAT'
  ...
  -- NORMAL CASE: Check if assignment's test matches question's test
  IF NOT EXISTS (
