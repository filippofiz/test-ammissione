#!/usr/bin/env python3
"""
Script to extract Verbal Reasoning and Data Insights questions
and generate a Typst document for language-focused GMAT study material.
"""
...
def extract_questions_from_ts(file_path):
    ...
    # Extract question objects using regex patterns
    # Match question blocks
    question_pattern = r'\{\s*id:\s*"([^"]+)".*?question_number:\s*(\d+).*?difficulty:\s*"([^"]+)".*?difficultyLevel:\s*(\d+)'

    # For VR questions with question_text
    vr_pattern = r'question_text:\s*"([^"]*(?:\\.[^"]*)*)"'

    # For VR passages
    passage_pattern = r'passage_text:\s*([A-Z_]+(?:\.[a-z]+)?(?:\.content)?|"[^"]*(?:\\.[^"]*)*")'
    ...
    # For DS statements
    statement1_pattern = r'statement1:\s*"([^"]*(?:\\.[^"]*)*)"'
    statement2_pattern = r'statement2:\s*"([^"]*(?:\\.[^"]*)*)"'

    # For TPA scenarios
    scenario_pattern = r'scenario:\s*"([^"]*(?:\\.[^"]*)*)"'

    # For MSR sources - more complex, need special handling
    msr_sources_pattern = r'sources:\s*(\[[^\]]+\]|[A-Z_]+)'

    return content

def clean_string(s):
    """Clean escaped characters in strings."""
    if s is None:
        return ""
    s = s.replace('\\n', '\n')
    s = s.replace('\\"', '"')
...
Has the predicted twin-peaked activity been observed for the actual yearly Geminid meteor shower? The Geminid data between 1970 and 1979 show just such a bifurcation, a secondary burst of meteor activity being clearly visible at an average of 19 hours (1,200,000 miles) after the first burst. The time intervals between the bursts suggest the actual Geminid stream is about 3,000 years old.""",
        ...
        "PASSAGE_TRADING_COMPANIES": """The modern multinational corporation is described as having originated when the owner-managers of nineteenth-century British firms carrying on international trade were replaced by teams of salaried managers organized into hierarchies. Increases in the volume of transactions in such firms are commonly believed to have necessitated this structural change. Nineteenth-century inventions like the steamship and the telegraph, by facilitating coordination of managerial activities, are described as key factors. Sixteenth- and seventeenth-century chartered trading companies, despite the international scope of their activities, are usually considered irrelevant to this discussion: the volume of their transactions is assumed to have been too low and the communications and transport of their day too primitive to make comparisons with modern multinationals interesting.
...
Fungus mimicry turns out to be a fairly widespread pollination strategy. Most of the fungus mimics are forest dwellers, which remain close to the ground and produce dark purple or brown flowers with pale or translucent patterns. To the human nose at least they are either scentless or musky in odor. Usually the flowers are simple urn- or kettle-shaped traps containing structures that closely resemble the gills or pores of mushrooms. Another element in their fungus mimicry is their exudation of moisture during the period when the flower is active. Fungus gnats of both sexes are involved in the pollination and are misled by a combination of fungus-like features—odor, color, shape, texture, and humidity."""
    ...
    # Verbal Reasoning Questions from SK
    vr_sk_questions = [
        {
            ...
            "passage_key": "PASSAGE_NIGHTINGALE",
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_NIGHTINGALE",
            "question": "With which of the following statements regarding the differing interpretations of Nightingale's importance would the author most likely agree?",
            "options": {
        ...
        },
        {
            ...
            "difficulty": "medium",
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_METEOR_STREAM",
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_METEOR_STREAM",
            "question": "It can be inferred from the passage that which of the following would most probably be observed during the Earth's passage through a meteor stream if the conventional theories mentioned in the highlighted text were correct?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_METEOR_STREAM",
            "question": "The passage suggests that which of the following is a prediction concerning meteor streams that can be derived from both the conventional theories mentioned in the highlighted text and the new computer derived theory?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_METEOR_STREAM",
            "question": "Which of the following is an assumption underlying the last sentence of the passage?",
            "options": {
        ...
        },
        {
            ...
            "difficulty": "medium",
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_TRADING_COMPANIES",
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_TRADING_COMPANIES",
            "question": "With which of the following generalizations regarding management structures would the author of the passage most probably agree?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_TRADING_COMPANIES",
            "question": "The passage suggests that modern multinationals differ from early chartered trading companies in that",
            "options": {
        ...
        },
        {
            ...
            "passage_key": None,
            "stimulus": "Correctly measuring the productivity of service workers is complex. Consider, for example, postal workers: they are often said to be more productive if more letters are delivered per postal worker. But is this really true? What if more letters are lost or delayed per worker at the same time that more are delivered?",
        ...
        },
        {
            ...
            "type": "Critical Reasoning",
            "passage_key": None,
            "stimulus": "Roland: The alarming fact is that 90 percent of the people in this country now report that they know someone who is unemployed.\nSharon: But a normal, moderate level of unemployment is 5 percent, with 1 out of 20 workers unemployed. So at any given time if a person knows approximately 50 workers, 1 or more will very likely be unemployed.",
            "question": "Sharon's argument is structured to lead to which of the following as a conclusion?",
            "options": {
        ...
        },
        {
            ...
            "type": "Critical Reasoning",
            "passage_key": None,
            "stimulus": "According to the Tristate Transportation Authority, making certain improvements to the main commuter rail line would increase ridership dramatically. The authority plans to finance these improvements over the course of five years by raising automobile tolls on the two highway bridges along the route the rail line serves. Although the proposed improvements are indeed needed, the authority's plan for securing the necessary funds should be rejected because it would unfairly force drivers to absorb the entire cost of something from which they receive no benefit.",
    ...
    # Verbal Reasoning Questions from PT1
    vr_pt1_questions = [
        {
        ...
        },
        {
            ...
            "difficulty": "medium",
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_TRADE_PROMOTIONS",
            "question": "According to the passage, some manufacturers have attempted to counteract retailer opportunism by",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_TRADE_PROMOTIONS",
            "question": "It can be inferred that the diaper manufacturer mentioned in the highlighted text of the passage discovered that consumers",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_TRADE_PROMOTIONS",
            "question": "The author of the passage would be most likely to agree with which of the following statements about consumers' knowledge of retail pricing strategies?",
            "options": {
        ...
        },
        {
            ...
            "difficulty": "hard",
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_CARBON_WOODLANDS",
            "question": "It can be inferred from the passage that Auclair's claim about carbon and the northern woodlands would be most seriously undermined if which of the following were true?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_CARBON_WOODLANDS",
            "question": "It can be inferred from the passage that the northern woodlands would be more likely to function as a carbon source if which of the following were to occur?",
            "options": {
        ...
        },
        {
            ...
            "difficulty": "medium",
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_ANCIENT_DNA",
            "question": "Which of the following statements, if true, would most clearly undermine the usefulness of the author's solution to the scientists' debate that is discussed in the passage?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_ANCIENT_DNA",
            "question": "The passage suggests that the scientists mentioned in the first highlighted portion of text differ from the scientists mentioned in the second highlighted portion of text in that the former",
            "options": {
        ...
        },
        {
            ...
            "difficulty": "medium",
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_FUNGUS_MIMICRY",
            "question": "The passage most strongly supports which of the following inferences about flower-cluster appendixes?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_FUNGUS_MIMICRY",
            "question": "Of the fungus-like features listed in the final sentence, the passage explicitly discusses which of the following as features of Arisarum proboscideum?",
            "options": {
                "A": "Odor and humidity",
                "B": "Odor and texture",
                "C": "Odor and shape",
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_FUNGUS_MIMICRY",
            "question": "Which of the following most accurately expresses the main idea of the passage?",
            "options": {
        ...
        },
        {
            ...
            "type": "Reading Comprehension",
            "passage_key": "PASSAGE_FUNGUS_MIMICRY",
            "question": "The passage most strongly supports the inference that the relationship between fungus gnats and Arisarum proboscideum is",
            "options": {
    ...
    # Data Insights Questions (language-heavy ones from SK and PT1)
    di_questions = [
        {
            ...
            "problem": "A stretch of highway, Segment X, has no traffic signals and comprises three speed zones: One with a speed limit of 55 miles per hour (mph) followed by a 75-mph zone and a second 55-mph zone. Leslie is at a certain point on Segment X, driving at a speed she will exactly maintain until after she has reached the end of Segment X and has entered the next highway segment. Is she driving faster than 55 mph?",
            "statement1": "Leslie's speed is at least 5 mph below the speed limit that currently applies to her.",
            "statement2": "Leslie will reach the end of Segment X without ever exceeding any speed limits.",
            "options": {
        ...
        },
        {
            ...
            "difficulty": "medium",
            "type": "Data Sufficiency",
            "problem": "Simon and Tara, who live in Neighborhood Z, wish to watch a movie together in a theater tonight. Simon only watches a movie in a theater if it is close to home and is of one of three genres: P, Q, and R. Tara does not watch movies of genres R or T in theaters. All movies playing in town tonight are of genre P, Q, or T. Will Simon and Tara watch a movie together in a theater tonight?",
            "statement1": "All movies of genre P or Q playing in town tonight are in theaters far from Neighborhood Z.",
        ...
        },
        {
            ...
            "difficulty": "hard",
            "type": "Data Sufficiency",
            "problem": "The Smiths take their children to a certain amusement park on exactly one Saturday every calendar month. Today is the 1st of July. Did the Smiths and their children make a trip to the amusement park on one of the past three days?",
            "statement1": "The Smiths made their June trip to the amusement park on one of the past seven days.",
        ...
        },
        {
            ...
            "difficulty": "hard",
            "type": "Data Sufficiency",
            "problem": "Each time Meg has visited a certain ice cream parlor with friends, she has bought chocolate ice cream, unless half or a majority of her accompanying friends all bought the same flavor of ice cream and that flavor was not chocolate—in which case Meg bought that flavor. Yesterday, Meg visited the parlor with four friends: Ann, Bart, Cathy, and Derek. Ann bought chocolate ice cream. Did Meg buy chocolate ice cream?",
            "statement1": "Bart bought either vanilla or chocolate ice cream, and Cathy bought neither vanilla nor chocolate ice cream.",
        ...
        },
        {
            ...
            "scenario": """The following excerpt from a fictitious science news report discusses a fictitious type of location called a morefa.
...
Based on the definition of the imaginary word morefa that can be inferred from the paragraph above, which of the following activities of a bird species must happen in a location for that location to be the species' morefa, and which must NOT happen in a location for that location to be the species' morefa?""",
            ...
            "answer": {"col1": "Gathering together with members of their own species", "col2": "Establishing nests"}
        },
        {
...
Select a writer who could be added to the schedule for either day. Then select a writer who could be added to the schedule for neither day.""",
            ...
            "answer": {"col1": "Murasaki (female, Japanese, Japan)", "col2": "Longfellow (male, English, USA)"}
        },
        {
...
Select Standard contemporary system for the option that the passage most strongly suggests is true of the standard contemporary system, and select Innovative, cutting-edge system for the option that the passage most strongly suggests is true of the innovative cutting-edge system.""",
            ...
            "answer": {"col1": "The most energy-efficient of the three database systems", "col2": "Costs Agro, on average, less per year to operate than either of the other systems"}
        },
        {
...
From among the options below, select for Response to Administrator Q and for Reply to that response two statements such that the first, if true, most strongly undermines Administrator Q's argument and the second, if true, is Administrator Q's strongest reply to that response.""",
            ...
            "answer": {"col1": "In general, requiring that research be published in open-access journals will likely result in new open-access journals in the field.", "col2": "For some disciplines, open-access journals tend to be of lower quality than other journals."}
        },
        {
            ...
            "difficulty": "easy",
            "type": "Two-Part Analysis",
            "scenario": """Art historian: Unlike many artistic traditions that sought to depict plants native to the local area in a seasonally appropriate way (for example, depicting scenes of spring with the plants in the appropriate stages of development for that season), seventeenth-century Dutch artists specializing in flower paintings almost exclusively chose to depict exotic species of flowers from outside the local area. Painting such species was worthwhile primarily because the art-buying public had developed a strong preference for images of the exotic. The great botanical centers of the time gave the artists direct access to such flowers, which the artists would freely combine in a single painting, regardless of whether the combined species occurred together in the wild, and depicted each in full bloom, regardless of whether those species bloomed at the same time in nature.
...
Select for 1 and for 2 the options that complete the statement so that it is most strongly supported by the information provided.""",
            ...
            "answer": {"col1": "worth painting", "col2": "exotic"}
        },
    ]

    # MSR Questions - Multi-Source Reasoning (highly language-dependent)
    msr_questions = [
        {
            "id": "DI-GMAT-SK__-00013-17",
            "number": "13-17",
            ...
            "sources": [
                {
                    "tab_name": "Techniques",
                    "content": """Island Museum analyzes historical artifacts using one or more techniques described below---all but one of which is performed by an outside laboratory---to obtain specific information about an object's creation. For each type of material listed, the museum uses only the technique described:
...
In analyzing these artifacts, the museum assumes that radiocarbon dating is accurate to approximately plus or minus 200 years and TL dating is accurate to approximately plus or minus 100 years."""
                ...
                {
                    "tab_name": "Budget",
                    "content": """For outside laboratory tests, the museum's first-year budget for the Kaxna collection allows unlimited IRMS testing, and a total of 7,000 USD---equal to the cost of 4 TL tests plus 15 radiocarbon tests, or the cost of 40 ICP-MS tests---for all other tests. For each technique applied by an outside lab, the museum is charged a fixed price per artifact."""
                }
            ],
            "sample_questions": [
    ...
    return passages, vr_sk_questions, vr_pt1_questions, di_questions, msr_questions


def main():
    """Main function to generate the Typst document."""

    passages, vr_sk_questions, vr_pt1_questions, di_questions, msr_questions = generate_typst_document()

    # Create Typst document
    typst_content = '''#set page(
  paper: "a4",
...
'''
    ...
    # Add RC questions for Nightingale passage
    nightingale_questions = [q for q in vr_sk_questions if q.get("passage_key") == "PASSAGE_NIGHTINGALE"]
    for i, q in enumerate(nightingale_questions, 1):
        typst_content += f'''
#question-box[
*Question {q["number"]}* ({q["difficulty"].capitalize()})
...
'''
        typst_content += f'''
#v(0.3em)
#text(size: 9pt, fill: gray)[Answer: {q["answer"]}]
]
...
'''
    ...
    # Add more passages and their questions
    typst_content += '''
#pagebreak()
...
'''
    ...
    # Add meteor stream questions
    meteor_questions = [q for q in vr_sk_questions if q.get("passage_key") == "PASSAGE_METEOR_STREAM"]
    for q in meteor_questions:
        typst_content += f'''
#question-box[
*Question {q["number"]}* ({q["difficulty"].capitalize()})
...
'''
    ...
    # Add trading companies questions
    trading_questions = [q for q in vr_sk_questions if q.get("passage_key") == "PASSAGE_TRADING_COMPANIES"]
...
'''
    ...
    # Add Critical Reasoning section
    typst_content += '''
#pagebreak()
...
'''
    ...
    # Add CR questions
    cr_questions = [q for q in vr_sk_questions if q["type"] == "Critical Reasoning"]
    for q in cr_questions:
        typst_content += f'''
#question-box[
*Question {q["number"]}* ({q["difficulty"].capitalize()} - Critical Reasoning)
...
'''
    ...
    # Add PT1 CR questions
    cr_pt1_questions = [q for q in vr_pt1_questions if q["type"] == "Critical Reasoning"]
    for q in cr_pt1_questions:
        typst_content += f'''
#question-box[
*Question PT1-{q["number"]}* ({q["difficulty"].capitalize()} - Critical Reasoning)
...
'''
    ...
    # Add DS questions
    ds_questions = [q for q in di_questions if q["type"] == "Data Sufficiency"]
    for q in ds_questions:
        typst_content += f'''
#question-box[
*Question {q["number"]}* ({q["difficulty"].capitalize()} - Data Sufficiency)
...
'''
    ...
    tpa_questions = [q for q in di_questions if q["type"] == "Two-Part Analysis"]
    for q in tpa_questions:
        typst_content += f'''
#question-box[
*Question {q["number"]}* ({q["difficulty"].capitalize()} - Two-Part Analysis)
...
*Column 1:* {q["column1_title"]} | *Column 2:* {q["column2_title"]}
...
'''
        ...
        typst_content += f'''
#v(0.3em)
#text(size: 9pt, fill: gray)[Answer: Column 1: {answer["col1"]} | Column 2: {answer["col2"]}]
]
...
'''
    ...
    for msr in msr_questions:
        typst_content += f'''
#question-box[
*Questions {msr["number"]}* ({msr["difficulty"].capitalize()} - Multi-Source Reasoning)

The following sources provide information about Island Museum's artifact analysis techniques and the Kaxna collection.

#v(0.5em)
'''
        for source in msr["sources"]:
            typst_content += f'''
#source-box[{source["tab_name"]}][
{source["content"]}
]
...
'''
        for sq in msr["sample_questions"]:
            typst_content += f'''
- {sq}
'''
...
'''
    ...
    # Add more PT1 RC passages and questions
    typst_content += '''
#pagebreak()
...
'''
    ...
    # Add trade promotions questions
    trade_promo_questions = [q for q in vr_pt1_questions if q.get("passage_key") == "PASSAGE_TRADE_PROMOTIONS"]
    for q in trade_promo_questions:
        typst_content += f'''
#question-box[
*Question PT1-{q["number"]}* ({q["difficulty"].capitalize()})
...
'''
    ...
    # Add carbon woodlands questions
    carbon_questions = [q for q in vr_pt1_questions if q.get("passage_key") == "PASSAGE_CARBON_WOODLANDS"]
    for q in carbon_questions:
        typst_content += f'''
#question-box[
*Question PT1-{q["number"]}* ({q["difficulty"].capitalize()})
...
'''
    ...
    # Add ancient DNA questions
    dna_questions = [q for q in vr_pt1_questions if q.get("passage_key") == "PASSAGE_ANCIENT_DNA"]
    for q in dna_questions:
        typst_content += f'''
#question-box[
*Question PT1-{q["number"]}* ({q["difficulty"].capitalize()})
...
'''
    ...
    # Add fungus mimicry questions
    fungus_questions = [q for q in vr_pt1_questions if q.get("passage_key") == "PASSAGE_FUNGUS_MIMICRY"]
    for q in fungus_questions:
        typst_content += f'''
#question-box[
*Question PT1-{q["number"]}* ({q["difficulty"].capitalize()})
...
#align(center)[
  ...
  #v(1em)
  #text(size: 12pt, fill: uptoten-green)[
...
'''
    ...
    # Write to file
    output_path = os.path.join(os.path.dirname(__file__), "language_questions.typ")
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(typst_content)

    print(f"Typst document generated: {output_path}")
    print("To compile to PDF, run: typst compile language_questions.typ")
